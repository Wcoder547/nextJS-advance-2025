...
export default function SendMessage() {
  ...
  const fetchSuggestedMessages = async () => {
    ...
    try {
      const response = await axios.post<{ content: string }>('/api/suggest-messages');
      const messages = parseStringMessages(response.data.content);
      setSuggestedMessages(messages);
    } catch (error) {
      console.error('Error fetching messages:', error);
      setSuggestError('Failed to fetch suggested messages. Try again later.');
    } finally {
